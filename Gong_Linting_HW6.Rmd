...
scatplot <- scatplot + geom_point(size=0.8) + ggtitle("Diamonds - Weight to Price by Color",colour="blue") + xlab("Weight")
...
WPBC <- WPBC + ylab("Price Residuals") + labs(colour = "factor(color)") + theme(legend.position="top")
